...
for (const text of ['Section 1: Reading and Writing','Section 2: Math','multiple-choice questions','You can move back and forth between questions until time expires.','Once the next module begins, you cannot return to these questions.']) if (!examJs.includes(text)) throw new Error(`missing official exam wording: ${text}`);
