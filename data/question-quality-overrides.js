(() => {
  ...
  const overrides = {
    ...
    MM1Q1: { type: 'mcq', options: ['5', '6', '7', '8'], answer: 'C' },
    MM1Q15: { type: 'mcq', options: ['48', '54', '66', '60'], answer: 'D' },
    MM2EQ3: { options: ['3', '4.5', '6', '7'] },
    MM2EQ14: { type: 'mcq', options: ['8', '7', '9', '10'], answer: 'A' },
    ...
    MM2HQ16: { difficulty: 'hard', prompt: 'A theater sells adult tickets for $18 and child tickets for $10. One performance sold 84 tickets for $1,384. How many child tickets were sold?', options: ['12', '16', '17', '20'], answer: 'B', explanation: 'Let a and c be adult and child tickets. Then a + c = 84 and 18a + 10c = 1384. Substituting a = 84 − c gives 1512 − 8c = 128? Correct calculation: 1512 − 8c = 1384, so 8c = 128 and c = 16. Therefore 16 child tickets were sold.' },
    ...
    MM2HQ20: { difficulty: 'hard', prompt: 'For x ≠ −4, if (3x − 2)/5 = (x + 6)/2, what is x?', type: 'mcq', options: ['32', '34', '36', '38'], answer: 'B', explanation: 'Cross-multiplying gives 2(3x − 2) = 5(x + 6), so 6x − 4 = 5x + 30 and x = 34.' },
