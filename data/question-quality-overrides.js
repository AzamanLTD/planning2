(() => {
  ...
  const overrides = {
    ...
    MM2HQ1: { difficulty: 'hard', prompt: 'The system 4x + 3y = 17 and 7x − 2y = 8 has a solution (x, y). What is the value of 2x − y?', options: ['−1', '1', '3', '5'], answer: 'B', explanation: 'Multiply the first equation by 2 and the second by 3: 8x + 6y = 34 and 21x − 6y = 24. Adding gives 29x = 58, so x = 2. Substituting into 4x + 3y = 17 gives y = 3. Therefore 2x − y = 1.' },
    ...
    MM2HQ16: { difficulty: 'hard', prompt: 'A theater sells adult tickets for $18 and child tickets for $10. One performance sold 84 tickets for $1,384. How many child tickets were sold?', options: ['12', '16', '17', '20'], answer: 'B', explanation: 'Let a and c be adult and child tickets. Then a + c = 84 and 18a + 10c = 1384. Substituting a = 84 − c gives 1512 − 8c = 1384, so c = 16. Therefore 16 child tickets were sold.' },
    ...
    MM2HQ21: { difficulty: 'hard', prompt: 'For x ≥ 0, if √(x + 9) + √x = 9, what is x?', type: 'spr', options: [], answer: '16', explanation: 'Let a = √x. Then √(a² + 9) = 9 − a. Squaring gives a² + 9 = 81 − 18a + a², so a = 4 and x = 16. The solution satisfies the original equation.' },
